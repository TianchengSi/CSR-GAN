...
parser.add_argument("--psnr-epochs", default=200, type=int, metavar="N",
...
parser.add_argument("--gan-epochs", default=40, type=int, metavar="N",
...
parser.add_argument("--psnr-lr", type=float, default=0.001,
                    help="Learning rate for psnr-oral. (default: 0.0001)")
parser.add_argument("--gan-lr", type=float, default=0.001,
