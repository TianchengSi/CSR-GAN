...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # dataset = BaseTestDataset(root=os.path.join(args.data, "test"), #no need
    #                           image_size=args.image_size,
    #                           upscale_factor=args.upscale_factor)

    dataset = BaseTestDataset(root=args.data,
                              image_size=args.image_size,
                              upscale_factor=args.upscale_factor)

    # dataset = CustomTestDataset(root=os.path.join(args.data))
